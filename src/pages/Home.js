...
const Home = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-600 to-blue-300 flex flex-col items-center justify-center">
      ...
      {/* CardGrid */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 w-4/5">
        {/* Cards */}
        {["Home", "Portfolio", "About Me", "Contact"].map((item, index) => (
          <div 
            ...
            style={{height: "40rem", width: "80%"}} // Adjusting card height and width
          >
            {/* Card Title */}
            <h2 className="text-xl font-bold text-gray-800 mb-4 text-center">{item}</h2>
            {/* Floating Image */}
            <div className="absolute top-1/3 transform -translate-y-1/3 w-60 h-60 bg-gray-300 rounded-full shadow-2xl border-4 border-gray-200 flex items-center justify-center">
